...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'texte', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'dateEnvoi', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'heureEnvoi', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'idUtilisateur'];
        }
    ...
    public function setHeureEnvoi($heureEnvoi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHeureEnvoi', [$heureEnvoi]);

        return parent::setHeureEnvoi($heureEnvoi);
    }
    ...
    public function getHeureEnvoi()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHeureEnvoi', []);

        return parent::getHeureEnvoi();
    }
